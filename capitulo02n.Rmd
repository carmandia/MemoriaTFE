...
```{r forma_extensiva_rigurosa, fig.cap = "\\label{forma_extensiva_rigurosa}Diagrama Juego", fig.align='center',out.width='80%'}
...
```{r forma_extensiva_rigurosa_2, fig.cap = "\\label{forma_extensiva_rigurosa_2}Diagrama Juego", fig.align='center',out.width='80%'}
knitr::include_graphics("forma_extensiva_rigurosa.png")
```
...
```{r forma_extensiva_equilibrio, fig.cap = "\\label{forma_extensiva_equilibrio}Diagrama Juego Equilibrio", fig.align='center',out.width='80%'}
